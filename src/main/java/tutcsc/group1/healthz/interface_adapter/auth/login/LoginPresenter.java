package tutcsc.group1.healthz.interface_adapter.auth.login;

import tutcsc.group1.healthz.use_case.auth.login.LoginOutputBoundary;
import tutcsc.group1.healthz.use_case.auth.login.LoginOutputData;
