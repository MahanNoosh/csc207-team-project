 ...
 *
 * Updated to work with FatSecretFoodGetClient.FoodDetails and ServingInfo.
 */
public class LogFoodIntakeUseCase {
     ...
     */
    public FoodLog execute(Profile profile, FatSecretFoodGetClient.FoodDetails food,
     ...
     */
    public FoodLog executeWithAmount(Profile profile, FatSecretFoodGetClient.FoodDetails food,
                                     FatSecretFoodGetClient.ServingInfo servingInfo,
