...
public class CalorieCalculator {
     ...
     * Uses existing HealthMetricsCalculator and NutritionAdvisorHelper
     */
    public static int calculateDailyCalorieGoal(Profile profile) {
        ...
        // Otherwise calculate using your existing helper
    ...
    /**
     * Get BMI for display (optional)
     */
    public static double calculateBMI(Profile profile) {
        return HealthMetricsCalculator.calculateBMI(profile);
    }

    /**
     * Get TDEE for display (optional)
     */
    public static double calculateTDEE(Profile profile) {
        return HealthMetricsCalculator.calculateTDEE(profile);
    }
}
