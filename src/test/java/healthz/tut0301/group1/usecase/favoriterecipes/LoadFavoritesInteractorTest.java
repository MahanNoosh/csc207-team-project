...
class LoadFavoritesInteractorTest {
    ...
    void failureGatewayExceptionTest() {
        ...
        LoadFavoritesOutputBoundary failurePresenter = new LoadFavoritesOutputBoundary() {
            ...
            @Override
            public void presentError(String errorMessage) {
                assertEquals("Failed to load favorites: Network error", errorMessage);
            }
        };

        LoadFavoritesInputBoundary interactor = new LoadFavoritesInteractor(failingGateway, failurePresenter);
